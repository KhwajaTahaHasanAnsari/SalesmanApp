...
var ref = new Firebase("https://generalsalesmenapp.firebaseio.com/");
var UserModel_1 = require("../DBRepo/UserModel");
var router = express.Router();
router.post("/signup",function (req ,res){
	ref.createUser({
		email:req.body.data.Password
...
router.get("/home", function (req, res) {
    ...
    var userArr = [{ name: "S 01", id: 1 }, { name: "S 02", id: 2 }, { name: "S 03", id: 3 }];
    res.send({ status: true, data: userArr });
});
